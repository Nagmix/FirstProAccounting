  ...
  Future<void> _deleteOrder(String id) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('هل أنت متأكد من حذف طلب الشراء هذا؟ لا يمكن التراجع عن هذا الإجراء.'),
        actions: [
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('تفاصيل طلب الشراء', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w700)),
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text('تغيير حالة طلب الشراء', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700)),
              ),
              const Divider(),
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: const Text('طلب شراء جديد', style: TextStyle(color: Colors.white)),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('المستلمة', style: theme.textTheme.bodySmall?.copyWith(color: Colors.white70)),
                const SizedBox(height: 4),
                Text('$receivedCount', style: theme.textTheme.titleLarge?.copyWith(color: Colors.white, fontWeight: FontWeight.w700)),
              ],
            ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.shopping_cart, size: 64, color: isDark ? AppColors.darkTextTertiary : AppColors.textTertiary),
          const SizedBox(height: 16),
          Text('لا توجد طلبات شراء', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: isDark ? AppColors.darkTextSecondary : AppColors.textSecondary)),
          const SizedBox(height: 8),
          Text('اضغط على + لإنشاء طلب شراء جديد', style: TextStyle(fontSize: 14, color: isDark ? AppColors.darkTextTertiary : AppColors.textTertiary)),
        ],
      ),
    );
  }
...
class _CreatePurchaseOrderForm extends StatefulWidget {
  ...
  @override
  State<_CreatePurchaseOrderForm> createState() => _CreatePurchaseOrderFormState();
}
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text('إنشاء طلب شراء جديد', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w700)),
                  const Spacer(),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              label: Text(_isSaving ? 'جاري الحفظ...' : 'حفظ طلب الشراء', style: const TextStyle(color: Colors.white, fontSize: 16)),
