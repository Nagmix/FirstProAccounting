...
import 'package:firstpro/ui/screens/currency_exchange/widgets/exchange_journal_entry_card.dart';
...
class _CurrencyExchangeScreenState extends State<CurrencyExchangeScreen>
  ...
  Widget _buildJournalEntryCard(ThemeData theme) {
    // U-05: extracted to ExchangeJournalEntryCard widget (in
    // lib/ui/screens/currency_exchange/widgets/) to reduce this
    // screen's size. The widget is purely presentational — it receives
    // the exchange map and a currency-symbol resolver.
    return ExchangeJournalEntryCard(
      exchange: _lastExchange!,
      theme: theme,
