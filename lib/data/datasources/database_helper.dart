...
class DatabaseHelper {
  ...
  //
  //  All pass-through methods that merely delegated to repository /
  //  service singletons have been deleted.  Callers should use the
  //  service locator directly instead:
  //
  //    locator<ProductRepository>().insertProduct(...)
  //    locator<CustomerRepository>().getAllCustomers(...)
  //    locator<InvoiceService>().getNextInvoiceSequence(...)
  //    locator<JournalService>().calculateExchangeGainLoss(...)
  //    locator<ShiftService>().insertHeldOrder(...)
  //    …etc.
  //
  //  Or use the DatabaseHelper sub-service getters:
  //    DatabaseHelper().products.insertProduct(...)
  //    DatabaseHelper().customers.getAllCustomers(...)
  // ══════════════════════════════════════════════════════════════
