...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  List<_QuickActionData> get _allServices => [
    ...
    _QuickActionData(label: 'عروض الأسعار', icon: PhosphorIconsRegular.fileText, color: Colors.purple, route: AppConstants.quotations),
    _QuickActionData(label: 'طلبات الشراء', icon: PhosphorIconsRegular.shoppingCart, color: Colors.teal, route: AppConstants.purchaseOrders),
    _QuickActionData(label: 'طلبات البيع', icon: PhosphorIconsRegular.package, color: Colors.indigo, route: AppConstants.salesOrders),
    _QuickActionData(label: 'الورديات', icon: PhosphorIconsRegular.clockCounterClockwise, color: Colors.brown, route: AppConstants.shifts),
