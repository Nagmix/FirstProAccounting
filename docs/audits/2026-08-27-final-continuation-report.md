...
**الفرع:** `main`
**آخر commit موثق:** `378499c fix: restore sale return stock on cancellation`
...
آخر تحقق كامل كان للـHEAD `378499cbb34777e703a7f9b0b54de2c379dc0054` عبر run [`33126697231`](https://github.com/Nagmix/FirstProAccounting/actions/runs/33126697231). النتيجة `success`، وسجل التشغيل يثبت **966 اختباراً ناجحاً**، مع نجاح التحليل والبناء والتوقيع ورفع artifacts.
...
- [GitHub Actions run 33126697231 — final HEAD](https://github.com/Nagmix/FirstProAccounting/actions/runs/33126697231)
